...
logger = setup_logger("MONTHLY_MAIN")

def main() -> None:
    parser = argparse.ArgumentParser(description=f"{APP_NAME} {VERSION}: Monthly Chronicle Engine")
    ...
    parser.add_argument("-t", "--format-test", action="store_true", help="Rendering test — save HTML to reports/monthly_format_test.html, skip email send")
